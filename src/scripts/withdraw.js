...
const config = {
  endpoint: "https://rpc.uni.agency.gives:443/",
  bech32prefix: "juno",
  feeDenom: "ujunox",
  mnemonic:
...
async function main() {
  ...
  let { balance: newBalance } = await client.queryContractSmart(agencyAddress, {
    balance: { address },
  });
  console.info(`New Balance: ${newBalance} uAGENCY`);

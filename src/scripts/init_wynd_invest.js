...
const initMsg = {
  ...
  max_investment_hex: "999999000000", // just shy of 1 million AGENCY
...
async function main() {
  ...
  const receipt = await client.instantiate(address, codeId, initMsg, "AGENCY Invest", "auto", {admin: address});

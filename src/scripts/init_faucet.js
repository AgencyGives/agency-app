...
async function main() {
  ...
  const {contractAddress} = await client.instantiate(address, contracts.facuetId, initMsg, "AGENCY Faucet", "auto", {admin: address});
  ...
  await client.execute(address, contracts.agencyAddr, execMsg, "auto", "Loading the faucet");
}

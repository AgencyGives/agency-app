        ...
        <>
          ...
          <Grid item xs={12}>
            <Typography variant="body">
              Hi, seems that you're using AGENCY for the first time! Follow some
            ...
            <Typography variant="body2" sx={{ display: "block", mt: 2 }}>
              ...
              <Link
                target="_blank"
                href="https://github.com/agency-answers/agency-app/blob/main/README.md"
              >

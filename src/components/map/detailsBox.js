...
import { investAgency } from "../../utils/client";
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      dispatch({
        type: "SET_MESSAGE",
        payload: {
          message: `Successfully invested ${amount} AGENCY to HEX ${state.chosenHex} in TX ${res.transactionHash}`,
          severity: "success",
        },
      });
      updateRows();
